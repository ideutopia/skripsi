const lab8String = {
  ...
  update: "10-11-2020",
  deskripsi:
    "Pada codelab kali ini anda akan membuat sebuah program yang akan menghitung luas dan keliling sebuah bangun datar. Pada program ini anda akan menerapkan seleksi kondisi dan methode dengan nilai balik dan tanpa nilai baik (void)",
  link: "/codelabs8",
  kategori: "Methode",
  intruksi: [
  ...
  penjelasan: [
    ...
    "Perhatikan dengan seksama dan bandingkan dengan kode yang telah anda tulis.",
  ],
};
