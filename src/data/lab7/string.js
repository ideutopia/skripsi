const lab7String = {
  ...
  update: "10-11-2020",
  deskripsi:
    "Pada codelab ini anda akan membuat sebuah program yang akan menampilkan sebuah piramida dengan ukuran sesuai yang disikan pengguna. Untuk membuat program ini anda akan menerapakan perulangan while.",
  link: "/codelabs7",
  kategori: "Perulangan",
  intruksi: [
